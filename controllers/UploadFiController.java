...
/**
 * Servlet implementation class UploadFiController
 */
@WebServlet("/UploadFiController")
@MultipartConfig(maxFileSize = 16000000)
public class UploadFiController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UploadFiController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try {
			...
			RequestDispatcher rd= request.getRequestDispatcher("UploadForEmployee.jsp");//Employee
